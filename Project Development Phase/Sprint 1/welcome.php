          ...
          <div class="row row-30">
            <div class="col-md-4 col-xl-5">
              <div class="pr-xl-4"><a class="brand" href="index.html"><img class="brand-logo-light" src="images/agency/logo-inverse-140x37.png" alt="" width="50px" height="50px" srcset="logo.png"></a>
                <p>Medicine Remainder System prevents people from missing a dose or accidentally taking more than one.</p>
                <!-- Rights-->
                <p class="rights"><span>©  </span><span class="copyright-year">2022</span><span> </span><span>MRS</span><span>. </span><span>All Rights Reserved.</span></p>
              </div>
            </div>
            <div class="col-md-4">
              <h5>Contacts</h5>
              <dl class="contact-list">
                <dt>Address:</dt>
                <dd>Dr.N.G.P.Institute of Technology,Kalapatti Road,Coimbatore-641048</dd>
              </dl>
              <dl class="contact-list">
                <dt>email:</dt>
                <dd><a href="mailto:#">kekekeke@gmail.com</a></dd>
              </dl>
              <dl class="contact-list">
                <dt>Phone no:</dt>
                <dd><a href="tel:#">+91 9876543210</a> <span>or</span> <a href="tel:#">+91 9988776655</a>
                </dd>
              </dl>
            </div>
